...
const Header = () => {
    ...
    return (
        <header className="min-h-[10vh] px-16 py-6 w-full rounded-b-full border-b-2 border-blue-600 bg-white/90 flex justify-between items-center shadow-sm">
            {/* LOGO */}
            ...
            {/* NAVIGTION */}
            <nav>
                <ul className="hidden md:flex items-center gap-8 text-gray-500 font-bold">
